                   ...
                   <Col>
                        <div className='d-flex justify-content-center align-items-center py-2'>
                            <div className='pb-5'>
                                ...
                                <Button className='btn-common rounded-pill common-bg' variant='transparent me-5'>Discover More</Button>
                                <Button variant='dark' className='btn-common rounded-pill pb-2'>View Our Service</Button>
                            </div>
                        </div>
                   </Col>
                   <Col></Col>
